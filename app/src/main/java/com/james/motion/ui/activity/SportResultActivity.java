...
//                .fromResource(R.drawable.mylocation_point));// 设置小蓝点的图标
    ...
    private void systemShareTxt() {
        ...
        intent.putExtra(Intent.EXTRA_TEXT, "我在" + UIHelper.getString(R.string.app_name) + "运动跑了" +decimalFormat.format(pathRecord.getDistance() / 1000d)
                + "公里,运动了" + MotionUtils.formatseconds(pathRecord.getDuration()) + "分钟!快来加入吧!");
